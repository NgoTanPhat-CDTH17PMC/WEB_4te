...
class ExportCylinderInformation extends React.Component {
  constructor(props) {
    super(props);
    this.form = null;
    this.state = {
    ...
    if (isCheck) {
      ...
      fileReader.onload = async function(event) {
        ...
        if (resultSearch.status === 200) {
          ...
          if (errCyl.length || errCyl_notCreated.length || errCyl_notInSystem.length) {
            let err1 = "",
              err2 = "",
              errorShow = "";
            const regex = /#/gi;
            ...
            errorShow = (err1 + err2).replace(regex, "\n").trim();
            that.setState({
              error: errorShow,
  ...
  render() {
    return (
      <div className="modal fade" id="export-cylinder-information" tabIndex="-1">
        ...
        <div className="modal-dialog modal-lg">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title">Xuất Vỏ Bình - Bước 1 - Nhập File</h5>
                    ...
                    <div className="col-md-6">
                      <div className="form-group">
                        ...
                        <div style={{ display: "flex" }}>
                          ...
                          />
                          <input type="reset" onClick={() => this.setState({ error: "" })} />
                        </div>
                      </div>
                      {this.state.error !== "" ? (
                        <div>
                    ...
                    <div className="row custom-scroll-table">
                      <Tabs>
                        ...
                        <TabPane tab="Bình chưa khai báo" key="4" >
                          ...
                          <Button className="center" type="success" icon={<DownloadOutline />} size="large" onClick={this.handleUpload}>
                            UPLOAD
                          </Button>
                          </div>
                        </TabPane>
                ...
                <footer className="card-footer text-center">
                  <button
                    ...
                    onClick={(event) => {
                      ...
                      this.handleContinue()
                      const modal = $("#export-cylinder-information");
                      modal.modal("hide");
                    }}
                    type="submit"
                    data-toggle="modal"
                    data-target="#export-driver-type-cylinder"
                  >
                    Tiếp Tục
                  </button>
                  <button
...
export default ExportCylinderInformation;
